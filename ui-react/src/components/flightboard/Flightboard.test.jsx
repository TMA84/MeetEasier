...
vi.mock('./FlightboardRow', () => ({
  default: function MockFlightboardRow({ room }) {
...
describe('Flightboard Component', () => {
  ...
  beforeEach(() => {
    // Reset fetch mock before each test - provide default response for all fetch calls
  ...
  describe('Socket Updates', () => {
    it('updates rooms when socket data is received', async () => {
      ...
      const { rerender: _rerender } = render(<Flightboard />);
