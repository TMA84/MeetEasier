...
const OAuthTab = ({
  ...
  oauthMessage,
  oauthMessageType,
  currentSystemGraphWebhookEnabled,
  currentSystemGraphWebhookClientState,
  currentSystemGraphWebhookAllowedIps,
  currentSystemGraphFetchTimeoutMs,
  currentSystemGraphFetchRetryAttempts,
  currentSystemGraphFetchRetryBaseMs,
  systemLastUpdated,
  ...
  graphRuntimeMessage,
  graphRuntimeMessageType,
  booleanLabel,
  onOAuthChange,
  onOAuthSubmit,
  onGraphRuntimeChange,
          ...
          <form onSubmit={onOAuthSubmit}>
            <div className="admin-form-group">
              ...
              <input
                ...
                id="oauthClientId"
                value={oauthClientId}
                onChange={(e) => onOAuthChange('oauthClientId', e.target.value)}
            ...
            <div className="admin-form-group">
              ...
              <input
                ...
                onChange={(e) => onOAuthChange('oauthAuthority', e.target.value)}
            ...
            <div className="admin-form-group">
              ...
              <input
                ...
                onChange={(e) => onOAuthChange('oauthClientSecret', e.target.value)}
              ...
              <form onSubmit={onGraphRuntimeSubmit}>
                <div className="admin-form-group">
                  <label className="inline-label">
                    ...
                    <input
                      ...
                      onChange={(e) => onGraphRuntimeChange('systemGraphWebhookEnabled', e.target.checked)}
                    />
                  </label>
                ...
                <div className="admin-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => onGraphRuntimeChange('systemGraphWebhookClientState', e.target.value)}
                ...
                <div className="admin-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => onGraphRuntimeChange('systemGraphWebhookAllowedIps', e.target.value)}
                ...
                <div className="admin-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => onGraphRuntimeChange('systemGraphFetchTimeoutMs', e.target.value)}
                    min="1000"
                    step="100"
                  />
                </div>
                ...
                <div className="admin-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => onGraphRuntimeChange('systemGraphFetchRetryAttempts', e.target.value)}
                    min="0"
                    step="1"
                  />
                </div>
                ...
                <div className="admin-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => onGraphRuntimeChange('systemGraphFetchRetryBaseMs', e.target.value)}
                    min="50"
                    step="50"
                  />
                </div>
