    ...
    <div className="admin-card" id="ops-ratelimit">
      {!rateLimitLocked && (
        <>
          ...
          {rateLimitMessage && (
            <AdminStatusMessage message={rateLimitMessage} messageType={rateLimitMessageType} />
          )}
      ...
      {rateLimitLocked && (
        <AdminLockedMessage title="Rate Limit Configuration" envMessage={t.configuredViaEnv} />
      )}
    </div>
    </div>
  );
