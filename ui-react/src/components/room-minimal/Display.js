...
const applyColorsToCSS = (colors) => {
  ...
  const css = `
    .room-minimal--available::before {
      background: radial-gradient(circle at 18% 24%, ${hexToRgba(availColor, 0.42)} 0%, transparent 62%) !important;
    }
    .room-minimal--busy::before {
      background: radial-gradient(circle at 18% 24%, ${hexToRgba(busyColor, 0.42)} 0%, transparent 62%) !important;
    }
    .room-minimal--upcoming::before {
      background: radial-gradient(circle at 18% 24%, ${hexToRgba(upcomColor, 0.42)} 0%, transparent 62%) !important;
    }
    ...
    .room-minimal--available .minimal-glow-container {
      box-shadow: inset 0 0 140px ${hexToRgba(availColor, 0.24)} !important;
    }
    .room-minimal--busy .minimal-glow-container {
      box-shadow: inset 0 0 140px ${hexToRgba(busyColor, 0.24)} !important;
    }
    .room-minimal--upcoming .minimal-glow-container {
      box-shadow: inset 0 0 140px ${hexToRgba(upcomColor, 0.24)} !important;
    }
    .room-minimal--not-found .minimal-glow-container {
      box-shadow: none !important;
    }
    .room-minimal--available .minimal-room-header--filled {
      background: linear-gradient(135deg, ${hexToRgba(availColor, 0.7)} 0%, ${hexToRgba(availColor, 0.52)} 100%) !important;
      border-color: ${hexToRgba(availColor, 0.62)} !important;
      box-shadow:
        0 20px 46px rgba(0, 0, 0, 0.42),
        0 10px 30px ${hexToRgba(availColor, 0.44)},
        inset 0 0 0 1px ${hexToRgba(availColor, 0.2)},
        inset 0 1px 0 rgba(255, 255, 255, 0.14) !important;
    }
    .room-minimal--busy .minimal-room-header--filled {
      background: linear-gradient(135deg, ${hexToRgba(busyColor, 0.7)} 0%, ${hexToRgba(busyColor, 0.52)} 100%) !important;
      border-color: ${hexToRgba(busyColor, 0.62)} !important;
      box-shadow:
        0 20px 46px rgba(0, 0, 0, 0.42),
        0 10px 30px ${hexToRgba(busyColor, 0.44)},
        inset 0 0 0 1px ${hexToRgba(busyColor, 0.2)},
        inset 0 1px 0 rgba(255, 255, 255, 0.14) !important;
    }
    .room-minimal--upcoming .minimal-room-header--filled {
      background: linear-gradient(135deg, ${hexToRgba(upcomColor, 0.7)} 0%, ${hexToRgba(upcomColor, 0.52)} 100%) !important;
      border-color: ${hexToRgba(upcomColor, 0.62)} !important;
      box-shadow:
        0 20px 46px rgba(0, 0, 0, 0.42),
        0 10px 30px ${hexToRgba(upcomColor, 0.44)},
        inset 0 0 0 1px ${hexToRgba(upcomColor, 0.2)},
        inset 0 1px 0 rgba(255, 255, 255, 0.14) !important;
    }
    .room-minimal--not-found .minimal-room-header--filled {
      background: ${hexToRgba(notFoundColor, 0.14)} !important;
    ...
    .room-minimal--available .minimal-room-header--transparent .minimal-room-status::before {
    ...
    .room-minimal--busy .minimal-room-header--transparent .minimal-room-status::before {
    ...
    .room-minimal--upcoming .minimal-room-header--transparent .minimal-room-status::before {
    ...
    .room-minimal--not-found .minimal-room-header--transparent .minimal-room-status::before {
      background: ${notFoundColor} !important;
    }
