...
const _cachePlugin = require('../app/msgraph/cache-plugin')(cacheLocation);
...
module.exports = {
  ...
  calendarSearch: {
    ...
    pollIntervalMs: process.env.SEARCH_POLL_INTERVAL_MS ? Math.max(parseInt(process.env.SEARCH_POLL_INTERVAL_MS, 10), 5000) : 30000
  },
