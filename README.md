...
- v1.0.0
  ...
  - **Room Booking Feature** - Book rooms directly from displays
    ...
    - Custom time selection with automatic end time calculation
    - Auto-filled meeting subject based on browser language (35+ languages)
    - Conflict detection prevents double-booking
    - Admin panel toggle to enable/disable booking
    - Environment variable control (ENABLE_BOOKING)
    - Fully translated modal (German/English)
    - Dark theme support for room-minimal display
    - Responsive design for all screen sizes
    - Booking button in sidebar for consistent positioning
    - Automatic permission detection - disables if Calendars.ReadWrite is missing
  - **Modern Design System**
    - Complete UI redesign with modern aesthetics
    - Dark theme for flightboard
    - Gradient backgrounds for room displays
  ...
  - **Technical Improvements**
    - Migrated all CSS to SCSS with modern modules
    - Fixed PostCSS deprecation warnings
...
- v0.6.0
  - **Room Booking Feature** - Book rooms directly from displays
    - Quick booking buttons (15/30/60 minutes)
    - Custom time selection with automatic end time calculation
    - Auto-filled meeting subject based on browser language
    - Conflict detection prevents double-booking
    - Admin panel toggle to enable/disable booking
    - Environment variable control (ENABLE_BOOKING)
    - Fully translated modal (German/English)
    ...
    - Booking button in sidebar for consistent positioning
  - **UI Improvements**
    - Removed emojis from booking interface
    - Fixed sidebar layout to prevent WiFi section from moving
    - Invisible placeholder button maintains consistent spacing
    - Added gap between WiFi info and booking button
- v0.5.0
  - Complete UI modernization with new design system
  - Fixed Microsoft Graph API pagination (30-item limit)
  - Added comprehensive admin panel at /admin
  - WiFi management with QR code generation and real-time updates
  - Logo management supporting both dark and light logos
  - File upload support for logos (JPG, PNG, GIF, SVG, WebP)
  - Real-time updates via Socket.IO for WiFi and logo changes
  - Browser language detection (German/English)
  - Locale-aware time formatting (12h/24h based on browser locale)
  - Modern flightboard with dark theme and URL-based filtering
  - Modern single-room and room-outside displays with gradient backgrounds
  - Animated status indicators with pulsing effects
  - Fixed all SCSS deprecation warnings (migrated to @use)
  - All security vulnerabilities resolved (0 CVEs)
  - API token authentication for admin endpoints
- v0.4.0
  - Upgraded to Node.js 20 and React 18
  - Fixed all security vulnerabilities (CVEs)
  - Modernized dependencies and build process
  - Improved Docker security with Alpine Linux
  - Added dropdown menu for room list filter
